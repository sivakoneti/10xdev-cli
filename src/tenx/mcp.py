...
def _tooldefs() -> list[dict[str, Any]]:
    ...
    return [
        ...
        {"name": "tenx_reconcile",
         "description": "Reconcile, pre-verify (tests and validate), merge, and tear down a subagent worktree and projected multiplexer session.",
         "inputSchema": {"type": "object", "properties": {
             "ticket": {**S, "description": "ticket id, e.g. SPC-032-T1"},
             "skip_verify": {**B, "description": "skip pre-landing validation checks (not recommended, default false)"}},
             "required": ["ticket"]},
         "handler": mk(C.cmd_reconcile, {"skip_verify": False, "json": False})},
        {"name": "tenx_abort",
         "description": "Abort and cleanly discard a subagent ticket worktree and multiplexer session without merging.",
         "inputSchema": {"type": "object", "properties": {
             "ticket": {**S, "description": "ticket id, e.g. SPC-032-T1"}},
             "required": ["ticket"]},
